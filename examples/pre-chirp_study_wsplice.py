...
import clipboard
from edf.re_nlse_joint_5level_wsplice import EDF as EDF_wsplice
import pynlo
import numpy as np
import matplotlib.pyplot as plt
import edf.edfa_wsplice as edfa_wsplice
import collections
from edf.utility import crossSection, ER80_4_125_betas, ER80_8_125_betas
...
polyfit_a = ER80_8_125_betas().polyfit
...
edf = EDF_wsplice(
    ...
    n_ion_2=n_ion_a,
    z_spl=z_spl,
    loss_spl=10 ** (-0.7 / 10),  # .7 dB splicing loss between gain fibers
    a_eff_1=a_eff_n,
    a_eff_2=a_eff_a,
    gamma_1=gamma_n,
    gamma_2=gamma_a,
